...
public class StockAddCommand extends BotCommand {

    private final String chatId;
    private final StockWrService stockWrDatabase;

    public StockAddCommand(String chatId, StockWrService stockWrDatabase) {
        super("add", "Add stock to the watchlist");
        this.chatId = chatId;
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        stockWrDatabase.addStocks(arguments);

        Set<Stock> stocks = stockWrDatabase.getAll();
        StringBuilder builder = new StringBuilder();
        builder.append("<b>Stocks added</b>");
        builder.append("\n");
        builder.append("\n");
        if (!stocks.isEmpty())
